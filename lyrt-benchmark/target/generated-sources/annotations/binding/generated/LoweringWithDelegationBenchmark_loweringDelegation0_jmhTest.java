...
public final class LoweringWithDelegationBenchmark_loweringDelegation0_jmhTest {
    ...
    public BenchmarkTaskResult loweringDelegation0_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_mystate2_2.setup();
                l_loweringwithdelegationbenchmark0_0.loweringDelegation0(l_mystate2_2, l_blackhole1_3);
                res.allOps++;
            }

            loweringDelegation0_thrpt_jmhStub(control, res, l_mystate2_2, l_blackhole1_3, l_loweringwithdelegationbenchmark0_0, l_blackhole1_1);
    ...
    public void loweringDelegation0_thrpt_jmhStub(InfraControl control, RawResults result, LoweringWithDelegationBenchmark_MyState_jmhType l_mystate2_2, Blackhole_jmhType l_blackhole1_3, LoweringWithDelegationBenchmark_jmhType l_loweringwithdelegationbenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult loweringDelegation0_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            loweringDelegation0_avgt_jmhStub(control, res, l_mystate2_2, l_blackhole1_3, l_loweringwithdelegationbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_mystate2_2.setup();
    ...
    public BenchmarkTaskResult loweringDelegation0_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            loweringDelegation0_sample_jmhStub(control, res, buffer, targetSamples, opsPerInv, batchSize, l_mystate2_2, l_blackhole1_3, l_loweringwithdelegationbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_mystate2_2.setup();
    ...
    public void loweringDelegation0_sample_jmhStub(InfraControl control, RawResults result, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, LoweringWithDelegationBenchmark_MyState_jmhType l_mystate2_2, Blackhole_jmhType l_blackhole1_3, LoweringWithDelegationBenchmark_jmhType l_loweringwithdelegationbenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult loweringDelegation0_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = control.iterationParams.getBatchSize();
            loweringDelegation0_ss_jmhStub(control, batchSize, res, l_mystate2_2, l_blackhole1_3, l_loweringwithdelegationbenchmark0_0, l_blackhole1_1);
            control.preTearDown();
    ...
    public void loweringDelegation0_ss_jmhStub(InfraControl control, int batchSize, RawResults result, LoweringWithDelegationBenchmark_MyState_jmhType l_mystate2_2, Blackhole_jmhType l_blackhole1_3, LoweringWithDelegationBenchmark_jmhType l_loweringwithdelegationbenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
