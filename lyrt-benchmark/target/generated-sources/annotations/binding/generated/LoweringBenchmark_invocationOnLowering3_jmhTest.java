...
public final class LoweringBenchmark_invocationOnLowering3_jmhTest {
    ...
    public BenchmarkTaskResult invocationOnLowering3_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_mystate2_2.setup();
                l_loweringbenchmark0_0.invocationOnLowering3(l_mystate2_2, l_blackhole1_3);
                res.allOps++;
            }

            invocationOnLowering3_thrpt_jmhStub(control, res, l_mystate2_2, l_blackhole1_3, l_loweringbenchmark0_0, l_blackhole1_1);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "invocationOnLowering3", res.measuredOps, res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void invocationOnLowering3_thrpt_jmhStub(InfraControl control, RawResults result, LoweringBenchmark_MyState_jmhType l_mystate2_2, Blackhole_jmhType l_blackhole1_3, LoweringBenchmark_jmhType l_loweringbenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult invocationOnLowering3_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            RawResults res = new RawResults();
            Blackhole_jmhType l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            LoweringBenchmark_jmhType l_loweringbenchmark0_0 = _jmh_tryInit_f_loweringbenchmark0_0(control, threadParams);
            ...
            invocationOnLowering3_avgt_jmhStub(control, res, l_mystate2_2, l_blackhole1_3, l_loweringbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_mystate2_2.setup();
            ...
            res.measuredOps /= batchSize;
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "invocationOnLowering3", res.measuredOps, res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void invocationOnLowering3_avgt_jmhStub(InfraControl control, RawResults result, LoweringBenchmark_MyState_jmhType l_mystate2_2, Blackhole_jmhType l_blackhole1_3, LoweringBenchmark_jmhType l_loweringbenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult invocationOnLowering3_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            RawResults res = new RawResults();
            Blackhole_jmhType l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            LoweringBenchmark_jmhType l_loweringbenchmark0_0 = _jmh_tryInit_f_loweringbenchmark0_0(control, threadParams);
            ...
            invocationOnLowering3_sample_jmhStub(control, res, buffer, targetSamples, opsPerInv, batchSize, l_mystate2_2, l_blackhole1_3, l_loweringbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_mystate2_2.setup();
            ...
            res.measuredOps *= opsPerInv;
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "invocationOnLowering3", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void invocationOnLowering3_sample_jmhStub(InfraControl control, RawResults result, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, LoweringBenchmark_MyState_jmhType l_mystate2_2, Blackhole_jmhType l_blackhole1_3, LoweringBenchmark_jmhType l_loweringbenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult invocationOnLowering3_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmhType l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            LoweringBenchmark_jmhType l_loweringbenchmark0_0 = _jmh_tryInit_f_loweringbenchmark0_0(control, threadParams);
            Blackhole_jmhType l_blackhole1_3 = _jmh_tryInit_f_blackhole1_3(control, threadParams);
            ...
            RawResults res = new RawResults();
            int batchSize = control.iterationParams.getBatchSize();
            invocationOnLowering3_ss_jmhStub(control, batchSize, res, l_mystate2_2, l_blackhole1_3, l_loweringbenchmark0_0, l_blackhole1_1);
            control.preTearDown();
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "invocationOnLowering3", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void invocationOnLowering3_ss_jmhStub(InfraControl control, int batchSize, RawResults result, LoweringBenchmark_MyState_jmhType l_mystate2_2, Blackhole_jmhType l_blackhole1_3, LoweringBenchmark_jmhType l_loweringbenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
