...
public final class LoweringBenchmark_loweringDelegation1_jmhTest {
    ...
    public BenchmarkTaskResult loweringDelegation1_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_mystate2_2.setup();
                l_loweringbenchmark0_0.loweringDelegation1(l_mystate2_2, l_blackhole1_3);
                res.allOps++;
            }

            loweringDelegation1_thrpt_jmhStub(control, res, l_mystate2_2, l_blackhole1_3, l_loweringbenchmark0_0, l_blackhole1_1);
    ...
    public void loweringDelegation1_thrpt_jmhStub(InfraControl control, RawResults result, LoweringBenchmark_MyState_jmhType l_mystate2_2, Blackhole_jmhType l_blackhole1_3, LoweringBenchmark_jmhType l_loweringbenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult loweringDelegation1_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            loweringDelegation1_avgt_jmhStub(control, res, l_mystate2_2, l_blackhole1_3, l_loweringbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_mystate2_2.setup();
    ...
    public void loweringDelegation1_avgt_jmhStub(InfraControl control, RawResults result, LoweringBenchmark_MyState_jmhType l_mystate2_2, Blackhole_jmhType l_blackhole1_3, LoweringBenchmark_jmhType l_loweringbenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult loweringDelegation1_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            loweringDelegation1_sample_jmhStub(control, res, buffer, targetSamples, opsPerInv, batchSize, l_mystate2_2, l_blackhole1_3, l_loweringbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_mystate2_2.setup();
    ...
    public void loweringDelegation1_sample_jmhStub(InfraControl control, RawResults result, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, LoweringBenchmark_MyState_jmhType l_mystate2_2, Blackhole_jmhType l_blackhole1_3, LoweringBenchmark_jmhType l_loweringbenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult loweringDelegation1_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = control.iterationParams.getBatchSize();
            loweringDelegation1_ss_jmhStub(control, batchSize, res, l_mystate2_2, l_blackhole1_3, l_loweringbenchmark0_0, l_blackhole1_1);
            control.preTearDown();
    ...
    public void loweringDelegation1_ss_jmhStub(InfraControl control, int batchSize, RawResults result, LoweringBenchmark_MyState_jmhType l_mystate2_2, Blackhole_jmhType l_blackhole1_3, LoweringBenchmark_jmhType l_loweringbenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
